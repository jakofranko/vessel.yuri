# Interactively write more story templates
class ActionListen
  ...
  def listen_scenes
    ...
    while continue
      ...
      puts "Current scenes: #{$scenes.get_by_arc_id(lowest_scenes_arc_id).map do |scene|

                                [scene.order, scene.describe]
